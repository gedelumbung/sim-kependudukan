        ...
        <div class="portlet-content">
          ...
          'encodeLabel'=>false,
              'items'=>array(
                  ...
                  array('label'=>'<i class="icon icon-user"></i> Data Kependudukan', 'url'=>array('/site/page', 'view'=>'graphs')),
                  array('label'=>'<i class="icon icon-user"></i> Account', 'url'=>array('/site/page', 'view'=>'graphs')),
